...
class Page3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Column(
      children: const [
      Image(image: NetworkImage( 'https://freebiespic.com/images/2016/11/IMG_7392_Little-Newborn-Baby-Rooster.jpg')),
    Text('দেশি মুরুগ পালন করা গ্রাম বাংলার মানুষদের একটি চড়াচরিত রীতিই বটে । দেশের অধিকাংশ গ্রামের বাড়িতে দেশি মুরগি পালণ করে থাকে এবং এটি প্রোটিনের সরবরাহ নিশ্চিত করে থাকে।'
